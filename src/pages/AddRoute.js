...
export default function AddRoute() {
  ...
  const isInValidFromRoute =
    ...
    data?.fromRoute?.length < 2 ||
    data?.fromRoute?.length > 50;
  const isInValidToRoute =
    data?.toRoute === undefined ||
    data?.toRoute?.length < 2 ||
    data?.toRoute?.length > 50;
  const isInValidDateType = data?.dateType === undefined;
  const isInValidCar = data?.carId === undefined;
  const isInValidPrepayment =
  ...
  const loadOptions2 = async (searchKey) => {
    ...
    setSelectPeriodType(
      optionsLoadingPeriodType?.find((item) => item.value === defaultValue)
    );

    if (!searchKey) {
      return await optionsLoadingPeriodType;
    } else {
      return await optionsLoadingPeriodType?.filter((item) =>
  ...
  const loadOptions3 = async (searchKey) => {
    ...
    setSelectDays(
      optionsLoadingDays?.find((item) => item.value === defaultValue)
    );

    if (!searchKey) {
      return await optionsLoadingDays;
    } else {
      return await optionsLoadingDays?.filter((item) =>
        item.label.includes(searchKey)
      );
    }
  };
          ...
          <div className="col-lg-8">
            <div className="mobile-indicators d-flex d-lg-none">
              <button
                type="button"
                style={{
                  background: data?.toRoute && data?.fromRoute && "#01BFC4",
                }}
              ...
              <button
                type="button"
                style={{
                  background: (data?.date || data?.datePeriodType) && "#01BFC4",
                }}
              ...
              <button
                ...
                style={{
                  background:
                    data?.contacts?.find((i) => i.phone && i.firstName) &&
                    "#01BFC4",
                }}
                        ...
                        <div className="box p-lg-3">
                          <label className="mb-2 mb-xl-3">
                            <input
                              ...
                              onClick={(e) =>
                                setBtnRadioDate(Number(e.target.value))
                              }
                            />
                          ...
                          >
                            ...
                            >
                              <AsyncSelect
                                ...
                                value={
                                  selectDays &&
                                  optionsLoadingDays?.find(
                                    (item) => item.value === selectDays.value
                                  )
                                }
                                onChange={(val) => {
                                  setSelectDays({
                            ...
                            <AsyncSelect
                              ...
                              value={
                                ...
                                optionsLoadingPeriodType?.find(
                                  (item) =>
                                    item.value === selectPeriodType.value
                                )
                              }
                              onChange={(val) => {
                                setSelectPeriodType({
                ...
                <div className="row align-items-center mb-4">
                  ...
                  <div className="col-md-9">
                    <AsyncSelect
                      ...
                      value={
                        selectCar &&
                        cars?.find((item) => item.value === selectCar.value)
                      }
                      onChange={(val, e) => {
                  ...
                  <div className="mb-2 mb-sm-0">
                    <label>
                      <input
                        ...
                        onClick={(e) =>
                          setBtnRadioBargain(Number(e.target.value))
                        }
                        value={0}
                  ...
                  <div className="mb-2 mb-sm-0">
                    <label>
                      <input
                        ...
                        onClick={(e) =>
                          setBtnRadioCalculate(Number(e.target.value))
                        }
                        name="calculateType"
                        onChange={(e) => onRadioHandler(e, setData, true)}
                        value={0}
                      ...
                      <div className="col-8 col-sm-5 col-xl-4">
                        ...
                        {valid.isInValidPrepayment && (
                          <span
                            className="position-absolute"
                            style={{
                              color: valid.isInValidPrepayment && "red",
                            }}
                          >
                            Поле обязательно для заполнения
                          </span>
                    ...
                    <div className="row align-items-center gy-2 gy-md-3">
                      ...
                      <div className="col-md-8">
                        ...
                        {valid.isInValidPhone && (
                          <span
                            className="position-absolute"
                            style={{ color: valid.isInValidPhone && "red" }}
                          >
                      ...
                      <div className="col-md-8">
                        <input
                          ...
                          style={{
                            borderColor: valid.isInValidFirstName && "red",
                          }}
                          placeholder="Имя"
                          className="w-100 fs-12"
                        />
                ...
                <ol>
                  <li>
                    <Link
                      ...
                      isDynamic={true}
                      className={
                        data?.fromRoute && data?.toRoute ? "filled" : ""
                      }
                    >
                      Маршрут
                    </Link>
                    <div className="fs-09">
                      ...
                      {data?.toRoute && (
                        <span className="me-1">— {data?.toRoute}</span>
                      )}
                      {data?.unloadingRadius && (
                        <span>+{data?.unloadingRadius}км</span>
                      )}
                    </div>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <div className="fs-09">{findCar(data?.carId)}</div>
                  </li>
                  <li>
                    <Link
                      activeClass="active"
                    ...
                    <div className="fs-09">
                      ...
                      {data?.priceVat && (
                        <span className="me-1">
                          , с&nbsp;НДС {data?.priceVat} ₽/км
                        </span>
                      )}
                      {data?.priceNovat && (
                        <span className="me-1">
                          , без&nbsp;НДС {data?.priceNovat} ₽/км
                        </span>
                      )}
                      {data?.prepay && (
                        <span>, предоплата {data?.prepay} %</span>
                      )}
                    </div>
                  </li>
                  <li>
            ...
            <div>
              ...
              <form className="fs-12">
                ...
                {valid.isInValidNameTemplate && (
                  <span style={{ color: valid.isInValidNameTemplate && "red" }}>
          ...
          <div className="d-flex align-items-center">
            <div className="flex-1">
                ...
                <div key={index} className="box patterns p-2 p-sm-4">
                  <div className="d-flex align-items-center">
                    <div className="flex-1">
                      ...
                      {item.note && (
                        <div className="fs-11 mt-1">{item.note}</div>
                      )}
                    </div>
                    <button
                      type="button"
                      ...
                      onClick={() => {
                        ...
                        setBtnRadioCalculate(
                          Number(item?.route?.calculateType)
                        );
                    ...
                    >
                      <IconContext.Provider
                        value={{ className: "gray-4 icon-15" }}
                      >
                        <IoTrash />
                      </IconContext.Provider>
                    </button>
              ...
              <p className="text-center fs-11">
                Сохраняйте однотипные объявления в шаблоны <br /> для удобства и
                экономии времени
              </p>
              <button
                type="button"
