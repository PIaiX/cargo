...
export default function EditCar() {
  ...
  useEffect(
    () =>
      getCar(axiosPrivate, id).then((result) => {
        reset({
          id: result?.id,
          name: result?.name,
  ...
  useEffect(() => {
    if (formData && userId) {
      ...
      updateCar(axiosPrivate, formData, userId)
        .then(() =>{
                        ...
                        <div className="mb-3 mb-sm-0">
                          <label>
                            <input
                              ...
                              onClick={(e) =>
                                setRadioBtnState(Number(e.target.value))
                              }
                            />
                ...
                <div className="row align-items-center mb-4">
                  ...
                  <div className="col-sm-7 col-md-9">
                    <div className="row">
                      <div className="col-md-4">
                      <ValidateWrapper
                          error={errors?.capacity || responseErrors?.capacity}
                        >
                          <input
                            type="number"
                            min="1"
                ...
                <div className="row align-items-center mb-4">
                  ...
                  <div className="col-md-9">
                    ...
                    >
                      ...
                      <div className="mb-2 mb-sm-0">
                      <ValidateWrapper
                          error={errors?.width || responseErrors?.width}
                        >
                          <div className="row gx-2 align-items-center">
                            <div
                              className={
