...
const ForumTopics = () => {
    const [topics, topicsPagination, isAuth] = useOutletContext()
    ...
    return (
        !isAuth
            ...
            : <p className="p-5 text-center col-lg-9 fs-5">
                Невозможно загрузить список тем. <NavLink to="/login" className="green fw-bold">Авторизуйтесь</NavLink>, чтобы посмотреть их
            </p>
    );
};
