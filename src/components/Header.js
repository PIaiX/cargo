...
export default function Header() {
  const isAuthenticated =
    useSelector((state) => state.currentUser.data.token) !== "";
    ...
    <>
      <header>
        ...
        <CustomModal
          ...
          titleBody={
            "Задайте интересующий вопрос и мы ответим Вам в течение часа."
          }
        >
          <form onSubmit={handleSubmit(handleFormSubmit)}>
            ...
            <div className="d-flex justify-content-center">
              <button className="btn btn-2 fs-12 text-uppercase mt-3">
                Задать вопрос
              </button>
            </div>
          </form>
      ...
      >
        <nav>
          <ul>
            <li>
              <NavLink to="/" onClick={() => setIsShowOffcanvas(false)}>
                Главная
              </NavLink>
            </li>
            <li>
              <NavLink to="/search" onClick={() => setIsShowOffcanvas(false)}>
                Поиск
              </NavLink>
            </li>
            <li>
              <NavLink to="/forum" onClick={() => setIsShowOffcanvas(false)}>
                Форум
              </NavLink>
            </li>
            <li>
              <NavLink
                to="/information-pay"
                onClick={() => setIsShowOffcanvas(false)}
              >
                Оплата
              </NavLink>
            </li>
            <li>
              <NavLink to="/contacts" onClick={() => setIsShowOffcanvas(false)}>
                Контакты
              </NavLink>
            </li>
            <li>
